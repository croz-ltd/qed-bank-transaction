...
public class TransactionController {
    ...
    private final transient BalanceService balanceService;
    ...
    public ResponseEntity<Response<String>> withdrawMoney(
        ...
        if (balanceByIban.isPresent()) {
            ...
            if (balance.getAmount().compareTo(modifyBalanceRequest.getAmount()) > 0) {
    ...
    private ResponseEntity<Response<String>> performModifyBalance(
        ...
        if (success.isPresent()) {
            ...
            if (success.get()) {
                ...
                return new ResponseEntity<>(Response.ok("Balance modified successfully!"), HttpStatus.OK);
            }
            // Fund addition failed. This should never occurred :S
            return new ResponseEntity<>(Response.ok("Balance not modified."), HttpStatus.BAD_REQUEST);
        }
